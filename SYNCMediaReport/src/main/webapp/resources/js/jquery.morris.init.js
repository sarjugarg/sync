...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b'], ['Series A', 'Series B'], ['#fff', '#fff']);

        //creating donut chart
        var $donutData = [
                {label: "News", value: 32},
                {label: "Total Channel", value: 40},
                {label: "Entertainment", value: 20},
                {label: "Music", value: 40}
            ];
        this.createDonutChart('morris-donut-example', $donutData, ['#7aa9d5','#d1d1d1', '#24b9ed', '#6887d4']);
         this.createDonutChart('morris-donut-example2', $donutData, ['#7aa9d5','#d1d1d1', '#24b9ed', '#6887d4']);
    },
    //init
