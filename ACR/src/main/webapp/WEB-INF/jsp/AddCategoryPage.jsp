...
<body>
		...
		<i class="fa fa-external-link-square"></i> Category management
...
function create1(){
	var categoryName = encodeURIComponent(document.getElementById('category').value);
	...
	//var formData = new FormData();
		...
		$.ajax({
			        	url: '${context}/InsertCategory/'+'?categoryName='+categoryName,
			            data :formData,
			            processData : false,
			            contentType : false,
			            type : 'POST',
			            success : function(data) {
			            	...
			            	//	//alert("Category is exust already..");
								document.getElementById("spantext").innerHTML = "Category is alreay Exist,please insert Fresh category. ";	
