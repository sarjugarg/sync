			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<i class="fa fa-external-link-square"></i>  ScheduleCampaign Table
						<div class="panel-tools">
							...
							<a class="btn btn-xs"
								...
								data-toggle="modal"  href="./addShedule"  >Schedule Campaign </a> <a
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title center">Schedule</h4>
								</div>
					...
					<div class="panel-body">
						<table
							...
							<tbody>
								...
								<% a++; %>
								<td><%=a %></td>
								<td>${schedule.channnelName}</td>
								<td>${schedule.campaignName}</td>
								<td>${schedule.startTime}</td>
								<td>${schedule.endTime}</td>
								<td>${schedule.spotCount}</td>
								<td>${schedule.cost}</td>
								
								<td class="center">
												<div>
													<a class="btn btn-xs btn-teal tooltips"
														data-placement="top" data-original-title="Edit" href="./editSchedule/${schedule.planId}"
														...
														onclick="document.getElementById('planId').value ='${schedule.planId}'"
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<form action="./deleteSchedule" method="post">
								<input type="text" id="planId" value="" name="planId"
									style="display: none;">
