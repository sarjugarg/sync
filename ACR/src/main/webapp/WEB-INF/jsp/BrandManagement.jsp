...
<div class="panel-heading">
	...
	<div class="panel-tools">
			...
			<a class="btn btn-xs" style="color: white; background-color: #0b738a; " 
				data-toggle="modal" href="./AddBrand">Create Brand </a> <a
				class="btn btn-xs btn-link panel-collapse collapses" href="#"> </a>
		</div>
	<div class="container" style="padding: 0px;min-height: 650px;">
		<div class="row">
		<div class="col-md-12">
							...
							<%int a = 0; %>
									<c:forEach items="${brand}" var="list">
										...
										<tr>
											...
											<figure>
											<img 
										src="${imageurl}${list.filename}"  style="width: 40px; height: 20px;margin-left:40px;">
											</figure>
											</div></c:when>
											<c:otherwise>
											<span>NA</span>
											...
											href="./brandEditById/${list.brandId}"><i
