...
<div class="panel-heading" style="background-color: white;">
	...
	<div class="panel-tools" style="background-color:white;">

			<a class="btn btn-xs" style="color: white; background-color: #0b738a; " 
				data-toggle="modal" href="./AddChannel">Create Channel </a> <a
							...
							<tbody style="background-color: white;">
								<%int a = 0; %>
									<c:forEach items="${list}" var="list">
										...
										<tr>
											<td><%=a %></td>
											<%-- <td><c:forEach items="${map}" var="map">
											<c:choose>
										...
										<%-- <--	<td>${list.imageHeight}</td> --%> 
											...
											<figure>
											<img 
										src="${channelImageUrl}${list.filename}"  style="width: 40px; height: 20px;margin-left:40px;">
											</figure>
											</div>
											</c:when>
											<c:otherwise>
											...
											href="./channelEditById/${list.channelId}/"><i
