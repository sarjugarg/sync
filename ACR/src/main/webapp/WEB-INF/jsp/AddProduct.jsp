...
function create1(){
	var productName = encodeURIComponent(document.getElementById('category').value);
	////alert("productName name==="+productName);
	...
	//var formData = new FormData();
		...
		$.ajax({
			        	url: '${context}/InsertProduct/'+'?productName='+productName,
			            data :formData,
			            processData : false,
			            contentType : false,
			            type : 'POST',
