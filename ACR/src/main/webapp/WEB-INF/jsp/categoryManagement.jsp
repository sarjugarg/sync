...
<div class="panel-heading">
	...
	<div class="panel-tools">
			...
			<a class="btn btn-xs" style="color: white; background-color: #0b738a; " 
				data-toggle="modal" href="./Addcategory">Create category </a> <a
								...
								<%int a = 0; %>
									<c:forEach items="${category}" var="list">
										<%a++; %>
											...
											<figure>
											<img 
										src="${categoryImageurl}${list.filename}"  style="width: 40px; height: 20px;margin-left:40px;">
											</figure>
											</div>
											</c:when>
											<c:otherwise>
											...
											href="./categoryManagment/${list.categoryId}"><i
